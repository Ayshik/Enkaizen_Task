...
const Delete = (e,id) => {
  e.preventDefault();
    ...
    axios.delete(`http://127.0.0.1:8000/api/Delete_user/${id}`)
                ...
                <div className="modal fade" id="updatepanel" tabIndex={-1} role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div className="modal-dialog" role="document">
                    <div className="modal-content">
                      ...
                      <div className="modal-footer">
                        <button type="button" className="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" name="updateadmin" className="btn btn-primary">Update</button>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="container-fluid">
            <table id="mytable" className="table table-hover">
              ...
              <tbody>
              {
               ...
               <td><Link to={`Update_user/${p.id}`} className="btn btn-success btn-sm">Edit</Link></td> 
